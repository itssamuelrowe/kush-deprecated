...
void k_Parser_compilationUnit(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    */
    ...
    k_Parser_match(parser, KUSH_TOKEN_END_OF_STREAM);
...
void k_Parser_importDeclaration(k_Parser_t* parser, k_ASTNode_t* node) {
	 ...
	 * we are expecting it.
	 */
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_IMPORT);
     ...
     * encountered.
     */
    k_Parser_pushFollowToken(parser, KUSH_TOKEN_NEWLINE);
    ...
    if (k_TokenStream_la(parser->m_tokens, 1) == KUSH_TOKEN_DOT) {
		k_TokenStream_consume(parser->m_tokens);
		k_Parser_match(parser, KUSH_TOKEN_ASTERISK);
	 ...
	 */
    k_Parser_match(parser, KUSH_TOKEN_NEWLINE);

    k_StackTrace_exit();
}

bool k_Parser_isAnnotatedComponentDeclarationFollow(k_TokenType_t token) {
    return (token == KUSH_TOKEN_AT) ||
           (token == KUSH_TOKEN_KEYWORD_FUNCTION) ||
           (token == KUSH_TOKEN_KEYWORD_CLASS) ||
           (token == KUSH_TOKEN_KEYWORD_ENUM);
}
...
void k_Parser_annotations(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    while (k_TokenStream_la(parser->m_tokens, 1) == KUSH_TOKEN_AT);
...
void k_Parser_annotation(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_AT);
	 ...
	 */
    while (k_TokenStream_la(parser->m_tokens, 1) == KUSH_TOKEN_IDENTIFIER) {
...
void k_Parser_annotationType(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    while (k_TokenStream_la(parser->m_tokens, 1) == KUSH_TOKEN_DOT) {
		 ...
		 */
        identifier = k_Parser_matchAndYield(parser, KUSH_TOKEN_IDENTIFIER);
        identifierNode = k_Parser_newTerminalNode(node, identifier);
        jtk_ArrayList_add(context->m_identifiers, identifierNode);
    }
...
void k_Parser_annotationAttribute(k_Parser_t* parser, k_ASTNode_t* node) {
	 ...
	 */
    k_Parser_match(parser, KUSH_TOKEN_EQUAL);
    ...
    if (k_Parser_isLiteralFollow(k_TokenStream_la(parser->m_tokens, 1))) {
        ...
        k_Parser_reportAndRecover(parser, KUSH_TOKEN_STRING_LITERAL);
    }
...
void k_Parser_componentDeclaration(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    switch (lt1->m_type) {
        case KUSH_TOKEN_KEYWORD_FUNCTION: {
            component = KUSH_AST_NODE_TYPE_FUNCTION_DECLARATION;
        ...
        case KUSH_TOKEN_KEYWORD_CLASS: {
            component = KUSH_AST_NODE_TYPE_CLASS_DECLARATION;
        ...
        default: {
            ...
            k_Parser_reportAndRecover(parser, KUSH_TOKEN_KEYWORD_CLASS);
            break;
        }
    }

    if (parser->m_mainComponent == KUSH_AST_NODE_TYPE_UNKNOWN) {
        ...
        if (parser->m_mainComponent != component) {
            k_ErrorHandler_handleSemanticalError(errorHandler, parser,
                KUSH_ERROR_CODE_CANNOT_DECLARE_MULTIPLE_TYPES_OF_COMPONENT, lt1);
        }
    }
...
void k_Parser_functionDeclaration(k_Parser_t* parser, k_ASTNode_t* node,
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_FUNCTION);
...
void k_Parser_functionParameters(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    /* Match and discard the '(' token. */
    k_Parser_match(parser, KUSH_TOKEN_LEFT_PARENTHESIS);
    ...
    /* Match and discard the ')' token. */
    k_Parser_match(parser, KUSH_TOKEN_RIGHT_PARENTHESIS);
...
void k_Parser_statementSuite(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    */
    ...
    // if (la1 == KUSH_TOKEN_NEWLINE) {
        ...
        /* Consume and discard the dedent token. */
        k_Parser_match(parser, KUSH_TOKEN_DEDENTATION);
    // }
...
bool k_Parser_isSimpleStatementFollow(k_TokenType_t type) {
    ...
    switch (type){
        ...
        case KUSH_TOKEN_KEYWORD_FINAL: /* simpleStatement -> constantDeclaration */
        case KUSH_TOKEN_KEYWORD_ASSERT: /* simpleStatement -> assertStatement */
        case KUSH_TOKEN_KEYWORD_BREAK: /* simpleStatement -> breakStatement */
        case KUSH_TOKEN_KEYWORD_CONTINUE: /* simpleStatement -> continueStatement */
...
void k_Parser_simpleStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    if (k_Parser_isExpressionFollow(la1)) {
        ...
        switch (la1) {
            ...
            case KUSH_TOKEN_KEYWORD_CONTINUE: {
...
void k_Parser_emptyStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    /* Match and discard the ';' token. */
	k_Parser_match(parser, KUSH_TOKEN_SEMICOLON);
...
void k_Parser_variableDeclaration(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_VAR);
...
void k_Parser_constantDeclaration(k_Parser_t* parser, k_ASTNode_t* node) {
	...
	k_Parser_match(parser, KUSH_TOKEN_KEYWORD_FINAL);
...
void k_Parser_assertStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_ASSERT);
...
void k_Parser_breakStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_BREAK);
...
void k_Parser_continueStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_CONTINUE);
...
void k_Parser_returnStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_RETURN);
...
void k_Parser_throwStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_THROW);
...
void k_Parser_compoundStatement(k_Parser_t* parser, k_ASTNode_t* node) {
	...
	switch (k_TokenStream_la(parser->m_tokens, 1)) {
		...
		case KUSH_TOKEN_KEYWORD_SYNCHRONIZE: {
...
bool k_Parser_isCompoundStatementFollow(k_TokenType_t type) {
    ...
    switch (type) {
		...
		case KUSH_TOKEN_KEYWORD_SYNCHRONIZE: /* compoundStatement -> synchronizeStatement */
		case KUSH_TOKEN_KEYWORD_WITH: /* compoundStatement -> withStatement */
		// case KUSH_TOKEN_KEYWORD_FUNCTION: /* compoundStatement -> functionDeclaration */
		// case KUSH_TOKEN_KEYWORD_CLASS: /* compoundStatement -> classDeclaration */
		{
            result = true;
			break;
		}
...
void k_Parser_ifClause(k_Parser_t* parser, k_ASTNode_t* node) {
	...
	k_Parser_match(parser, KUSH_TOKEN_KEYWORD_IF);
...
void k_Parser_elseIfClause(k_Parser_t* parser, k_ASTNode_t* node) {
	...
	k_Parser_match(parser, KUSH_TOKEN_KEYWORD_ELSE);
	k_Parser_match(parser, KUSH_TOKEN_KEYWORD_IF);
...
void k_Parser_labelClause(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    /* Match and discard the '#' token. */
	k_Parser_match(parser, KUSH_TOKEN_HASH);
...
void k_Parser_whileStatement(k_Parser_t* parser, k_ASTNode_t* node) {
	...
	k_Parser_match(parser, KUSH_TOKEN_KEYWORD_WHILE);
...
void k_Parser_forParameter(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_TokenType_t la1 = k_TokenStream_la(parser->m_tokens, 1);
    if ((la1 == KUSH_TOKEN_KEYWORD_VAR) || (la1 == KUSH_TOKEN_KEYWORD_FINAL)) {
        context->m_declaration = true;
        context->m_variable = (la1 == KUSH_TOKEN_KEYWORD_VAR);
...
void k_Parser_forStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_FOR);
	...
	k_Parser_match(parser, KUSH_TOKEN_KEYWORD_IN);
...
void k_Parser_tryClause(k_Parser_t* parser, k_ASTNode_t* node) {
	...
	k_Parser_match(parser, KUSH_TOKEN_KEYWORD_TRY);
...
void k_Parser_catchClause(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_CATCH);
...
void k_Parser_finallyClause(k_Parser_t* parser, k_ASTNode_t* node) {
	...
	k_Parser_match(parser, KUSH_TOKEN_KEYWORD_FINALLY);
...
void k_Parser_synchronizeStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_SYNCHRONIZE);
...
void k_Parser_withStatement(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_WITH);
...
void k_Parser_withParameters(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_TokenType_t la1 = k_TokenStream_la(parser->m_tokens, 1);
    while (la1 == KUSH_TOKEN_COMMA) {
        /* Match and discard the ',' token. */
        k_Parser_match(parser, KUSH_TOKEN_COMMA);
...
void k_Parser_classDeclaration(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_CLASS);

    k_Token_t* identifier = k_Parser_matchAndYield(parser, KUSH_TOKEN_IDENTIFIER);
    context->m_identifier = k_Parser_newTerminalNode(node, identifier);

    if (k_TokenStream_la(parser->m_tokens, 1) == KUSH_TOKEN_LEFT_ANGLE_BRACKET_EQUAL) {
...
void k_Parser_classExtendsClause(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    /* Consume and discard the '<=' token. */
    k_Parser_match(parser, KUSH_TOKEN_LEFT_ANGLE_BRACKET_EQUAL);
...
bool k_Parser_isClassMemberFollow(k_TokenType_t type) {
    return k_Parser_isClassMemberModifier(type) || /* classMember -> modifier */
           (type == KUSH_TOKEN_KEYWORD_VAR)        || /* classMember -> ... -> variableDeclaration */
           (type == KUSH_TOKEN_KEYWORD_FINAL)      || /* classMember -> ... -> constantDeclaration */
           (type == KUSH_TOKEN_KEYWORD_FUNCTION)   || /* classMember -> ... -> functionDeclaration */
           // (type == KUSH_TOKEN_IDENTIFIER)      || /* classMember -> ... -> constructorDeclaration */
           // (type == KUSH_TOKEN_KEYWORD_CLASS)      || /* classMember -> ... -> classDeclaration */
           // (type == KUSH_TOKEN_KEYWORD_ENUM)       || /* classMember -> ... -> enumerationDeclaration */
           (type == KUSH_TOKEN_AT);                   /* classMember -> ... -> annotatedClassMember */
}
...
//         }
        ...
        default: {
            ...
            k_Parser_reportAndRecover(parser, KUSH_TOKEN_KEYWORD_FUNCTION);
...
bool k_Parser_isClassMemberModifier(k_TokenType_t type) {
    return (type == KUSH_TOKEN_KEYWORD_STATIC) ||
           (type == KUSH_TOKEN_KEYWORD_NATIVE) ||
           (type == KUSH_TOKEN_KEYWORD_ABSTRACT) ||
           (type == KUSH_TOKEN_KEYWORD_PUBLIC) ||
           (type == KUSH_TOKEN_KEYWORD_PRIVATE) ||
           (type == KUSH_TOKEN_KEYWORD_SECRET);
}
...
//     k_Parser_match(parser, KUSH_TOKEN_KEYWORD_ENUM);
...
//     /* Match and discard the ':' token. */
//     k_Parser_match(parser, KUSH_TOKEN_COLON);
...
void k_Parser_subscript(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    /* Match and discard the '[' token. */
    k_Parser_match(parser, KUSH_TOKEN_LEFT_SQUARE_BRACKET);

    /* If expression fails, discard tokens until the ']' token is
     * encountered.
     */
    k_Parser_pushFollowToken(parser, KUSH_TOKEN_RIGHT_SQUARE_BRACKET);
    ...
    /* Match and discard the ']' token. */
    k_Parser_match(parser, KUSH_TOKEN_RIGHT_SQUARE_BRACKET);
...
void k_Parser_functionArguments(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    if (k_Parser_isExpressionFollow(k_TokenStream_la(parser->m_tokens, 1))) {
        ...
        * encountered.
        */
        k_Parser_pushFollowToken(parser, KUSH_TOKEN_RIGHT_PARENTHESIS);
...
void k_Parser_memberAccess(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    /* Match and discard the '.' token. */
    k_Parser_match(parser, KUSH_TOKEN_DOT);
...
void k_Parser_mapExpression(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    /* Match and discard the '{' token. */
    k_Parser_match(parser, KUSH_TOKEN_LEFT_BRACE);

    /* If expression fails, discard tokens until the '}' token is
     * encountered.
     */
    k_Parser_pushFollowToken(parser, KUSH_TOKEN_RIGHT_BRACE);
    ...
    /* Match and discard the '}' token. */
    k_Parser_match(parser, KUSH_TOKEN_RIGHT_BRACE);
...
void k_Parser_newExpression(k_Parser_t* parser, k_ASTNode_t* node) {
    ...
    k_Parser_match(parser, KUSH_TOKEN_KEYWORD_NEW);
