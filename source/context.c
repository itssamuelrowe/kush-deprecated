...
void initializePrimitives() {
    ...
    primitives.ui64.llvmDefaultValue = LLVMConstInt(primitives.ui64.llvmType, 0, false);

    primitives.f32.arrayTypes = jtk_ArrayList_new();
    primitives.f32.llvmType = LLVMFloatType();
    primitives.f32.llvmDefaultValue = LLVMConstReal(primitives.f32.llvmType, 0.0);

    primitives.f64.arrayTypes = jtk_ArrayList_new();
    primitives.f64.llvmType = LLVMDoubleType();
    primitives.f64.llvmDefaultValue = LLVMConstReal(primitives.f64.llvmType, 0.0);
