...
enum k_TokenType_t {
    ...
    KUSH_TOKEN_KEYWORD_OR,

    KUSH_TOKEN_KEYWORD_AND,
    ...
    KUSH_TOKEN_KEYWORD_ENUM,
    KUSH_TOKEN_KEYWORD_GOTO,
    ...
    KUSH_TOKEN_KEYWORD_CONST,
    KUSH_TOKEN_KEYWORD_FALSE,
    KUSH_TOKEN_KEYWORD_THROW,
    KUSH_TOKEN_KEYWORD_WHILE,

    KUSH_TOKEN_KEYWORD_EXTERN,
    KUSH_TOKEN_KEYWORD_RETURN,

    KUSH_TOKEN_KEYWORD_CONTINUE,
    KUSH_TOKEN_KEYWORD_DEFAULT,
...
#endif /* COM_ONECUBE_KUSH_COMPILER_LEXER_TOKEN_TYPE_H */
