...
enum ErrorCode {
    ...
    ERROR_UNDECLARED_STRUCTURE,
    ERROR_UNDECLARED_IDENTIFIER,
    ERROR_REDECLARATION_OF_SYMBOL_AS_FUNCTION,
    ERROR_REDECLARATION_OF_SYMBOL_AS_PARAMETER,
    ERROR_REDECLARATION_OF_SYMBOL_AS_VARIABLE_PARAMETER,
    ERROR_REDECLARATION_OF_SYMBOL_AS_VARIABLE,
    ERROR_REDECLARATION_OF_SYMBOL_AS_CONSTANT,
    ERROR_REDECLARATION_OF_SYMBOL_AS_LABEL,
    ERROR_REDECLARATION_OF_SYMBOL_AS_LOOP_PARAMETER,
    ERROR_REDECLARATION_OF_SYMBOL_AS_CATCH_PARAMETER,
    ERROR_REDECLARATION_OF_SYMBOL_AS_STRUCTURE,
    ERROR_REDECLARATION_OF_SYMBOL_PREVIOUSLY_IMPORTED,
