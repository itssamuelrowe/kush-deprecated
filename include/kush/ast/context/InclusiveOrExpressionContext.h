...
#ifndef KUSH_COMPILER_AST_CONTEXT_INCLUSIVE_OR_EXPRESSION_CONTEXT_H
#define KUSH_COMPILER_AST_CONTEXT_INCLUSIVE_OR_EXPRESSION_CONTEXT_H
...
#endif /* KUSH_COMPILER_AST_CONTEXT_INCLUSIVE_OR_EXPRESSION_CONTEXT_H */
