...
#ifndef KUSH_COMPILER_AST_CONTEXT_ENUMERATE_CONTEXT_H
#define KUSH_COMPILER_AST_CONTEXT_ENUMERATE_CONTEXT_H
...
#endif /* KUSH_COMPILER_AST_CONTEXT_ENUMERATE_CONTEXT_H */
