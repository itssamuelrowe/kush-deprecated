...
#ifndef KUSH_COMPILER_AST_CONTEXT_ELSE_IF_CLAUSE_CONTEXT_H
#define KUSH_COMPILER_AST_CONTEXT_ELSE_IF_CLAUSE_CONTEXT_H
...
#endif /* KUSH_COMPILER_AST_CONTEXT_ELSE_IF_CLAUSE_CONTEXT_H */
