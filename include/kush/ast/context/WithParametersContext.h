...
#ifndef KUSH_COMPILER_AST_CONTEXT_WITH_PARAMETERS_CONTEXT_H
#define KUSH_COMPILER_AST_CONTEXT_WITH_PARAMETERS_CONTEXT_H
...
#endif /* KUSH_COMPILER_AST_CONTEXT_WITH_PARAMETERS_CONTEXT_H */
